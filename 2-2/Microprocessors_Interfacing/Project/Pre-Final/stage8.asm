...
; intialize ds, es,ss to start of RAM
          ...
          mov       sp,0FFEH			;Initializing SP
			...
			mov		AL,10011000b			;To set Port A in inp mode for rows and Port B in out mode for columns and port c lower as o/p for alarm led
...
START:  
			...
			mov 	AL,96h				;Setting count(2500) in counter0 ???CHANGE COUNT VALUE TO 2500 ---
			out		cntReg0,AL
			mov 	AL,00h
			out		cntReg0,AL
			;mov al,'/'
